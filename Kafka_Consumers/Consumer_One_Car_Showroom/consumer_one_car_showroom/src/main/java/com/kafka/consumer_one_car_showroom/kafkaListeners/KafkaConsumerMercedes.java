package com.kafka.consumer_one_car_showroom.kafkaListeners;
...
public class KafkaConsumerMercedes {
    ...
    public void consumeMercedesASeries(String car) {
        logger.info("---------> Receiving Mercedes A Series Car In Consumer One <---------");
    ...
    public void consumeMercedesESeries(String car) {
        logger.info("---------> Receiving Mercedes E Series Car In Consumer One <---------");
